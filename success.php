            ...
            <div class="container mt-n10">
                <div class="row">
                    <div class="col-12">
                      ...
                      <p class="lead">Your work has been successfully saved in our Database.</p>
                      <hr class="my-4">
                      <p>Want to check out our lastest product.</p><p> Click the button below.</p>
                      <a class="btn btn-primary btn-lg" href="index.php" role="button">Click Me</a>
                    </div>
