            ...
            <div class="container z-2">
                <div class="row py-4 py-md-6 pb-1 justify-content-center text-white text-center">
                    <div class="col-12 col-md-10">
                        <div class="mb-3">
                            <h1 class="display-3 font-size-md-down-5 font-weight-light mb-0">Services<span class="font-weight-bold"> provided</span> by us.</h1>
                        </div>
                        <p class="my-4 px-0 px-lg-7 lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim </p>
                        <a href="./services.php" class="btn btn-tertiary mr-3 animate-up-2">Get started</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-12">
                    <div class="row justify-content-center mt-n7 z-2">
                            ...
                            <div class="row mt-5 mt-lg-0 mr-md-1">
                                ...
                                <div class="card border-light">
                                    <div class="card-body p-5">
                                        <img src="./assets/img/159.svg" alt="Web design illustration" class="image-md mb-4">
                                        <h2 class="h4 mb-2">Faster Delievery</h2>
                                ...
                                <div class="card border-light mt-3">
                                    <div class="card-body p-5">
                                        <img src="./assets/img/156.svg" alt="Responsive illustration" class="image-md mb-4">
                                        <h2 class="h4 mb-2">Friendly Support</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim</p>
                                        <a href="#" class="btn btn-sm btn-primary">Learn more</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-md-6 mt-5">
                            <div class="row mt-3 mt-lg-0 mr-1">
                                <!-- Icon Boxes -->
                                <div class="card border-light">
                                    <div class="card-body p-5">
                                        <img src="./assets/img/158.svg" alt="Code illustration" class="image-md mb-4">
                                        <h2 class="h4 mb-2">New Trends</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim </p>
                                        <a href="#" class="btn btn-sm btn-primary">Learn more</a>
                                    </div>
                                </div>
                                ...
                                <div class="card border-light mt-3">
                                    <div class="card-body p-5">
                                        <img src="./assets/img/157.svg" alt="Support illustration" class="image-md mb-4">
                                        <h2 class="h4 mb-2">Thousand of brand to chose from</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim</p>
                                        <a href="#" class="btn btn-sm btn-primary">Learn more</a>
                                    </div>
                                </div>
