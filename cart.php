                    ...
                    <div class="col-12">
                      <div class="jumbotron">
                        <?php
                          ...
                          echo '<h1 class="display-4">Your Shopping Cart</h1>';
                                ...
                                echo '
                                      <tbody >
                                        <tr >
                                          ...
                                          <td>'.$quantity.'&nbsp;<a class="btn btn-success btn-sm" role="button" style="padding:5px;" href="update-cart.php?action=add&id='.$product_id.'">+</a>&nbsp;<a class="btn btn-danger btn-sm " role="button" style="padding:5px;" href="update-cart.php?action=remove&id='.$product_id.'">-</a></td>
                                          <td>'.$cost.'</td>
                                        </tr>
                          ...
                          <tr>
                          <td colspan="3" ><a href="update-cart.php?action=empty" class="btn btn-danger btn-lg " role="button">Empty Cart</a>&nbsp;<a href="products.php" class="btn btn-success btn-lg" role="button">Continue Shopping</a></td>
                          <td>';

                          if(isset($_SESSION['username'])) {
                            echo '<a href="orders-update.php" class="btn btn-primary btn-lg mr-auto" role="button" >COD</a>';
                          }
                          else {
                            echo '<a href="sign-in.php" class="btn btn-primary btn-lg mr-auto" role="button" >Login</a>';
                          }
                          echo '</td>
                          </tr>
                          </tbody>
                          ...
                          echo '<p class="lead">You have no items in your shopping cart</p>
  <hr class="my-4">
